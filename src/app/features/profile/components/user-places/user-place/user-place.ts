...
import { PlaceModal } from 'src/app/shared/components/place-card/place-modal/place-modal';
import { Place } from 'src/app/shared/interfaces/place-interface';
import { ConfirmDelete } from '../../place-posts/confirm-delete-post/confirm-delete/confirm-delete';
